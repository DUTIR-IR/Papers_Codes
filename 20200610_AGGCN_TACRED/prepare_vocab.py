...
# from mainprocess import mani_fold
...
def main():
    ...
    train_file = './dataset/tacred/new.json'
    #dev_file = args.data_dir + '/dev.json'
    dev_file = './dataset/tacred/dev.json'
    #test_file = args.data_dir + '/test.json'
    test_file = './dataset/tacred/test.json'
